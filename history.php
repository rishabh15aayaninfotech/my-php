...
<title>History | Birbal Sahni Institute of Palaeosciences</title>
      ...
      <div class="container py-3">
        <div class="row gx-5">
          ...
          <div class="col-md-9 content">
            ...
            <div class="row">
              <div class="col-md-3"><img src="https://www.bsip.res.in/images/pages/inauguration%20speach.gif"
                  alt="History Image 1" class="img-fluid img-history"></div>
              <div class="col-md-9">
                <p class="normal-text">The Birbal Sahni Institute of Palaeobotany commemorates the name of its reverend
                  founder, Professor
            ...
            <div class="row">
              <div class="col-md-12">
                <p class="normal-text">A trust that name was created on 3rd June, under the Societies Registration
            ...
            <div class="row">
              <div class="col-md-9">
                <p class="normal-text">This trust was assigned the job for the foundation of a Research Institute. By a
              ...
              <div class="col-md-3"><img src="https://www.bsip.res.in/images/pages/inauguration%20speach.gif"
                  alt="History Image 2" class="img-fluid img-history"></div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <p class="normal-text">Unfortunately after a week on 10th April 1949 Prof. Sahni passed away leaving the
                ...
                <p class="normal-text">In 1951, the United Nations Educational, Scientific and Cultural Organization
