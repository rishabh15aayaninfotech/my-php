  ...
  for (i = 0; (cacheobj = document.getElementsByTagName("link")[i]); i++) {
    if (
      ...
      if (cacheobj.getAttribute("title") == title) {
        ...
        if (cacheobj.media) setStylesheet.chosen.media = cacheobj.media;
...
jQuery(document).ready(function () {
  ...
  jQuery(".dark").click(function () {
    ...
    jQuery(".dark").hide();
    jQuery("head").append(
      '<link rel="stylesheet" type="text/css" media="screen" href="assets-new/assets/css/change.css">'
    );
    jQuery("head").append(
      '<link rel="stylesheet" type="text/css" media="screen" href="assets-new/theme/css/site-change.css">'
    );
    jQuery(".national_emblem").attr(
      "src",
      "assets-new/assets/images/bsip-logo.png"
    ); // high contrast

    jQuery(".ico-skip img.top").attr(
      "src",
      "assets-new/assets/images/ico-skip-y.png"
    );
    jQuery(".ico-skip img.bottom").attr(
      "src",
      "assets-new/assets/images/ico-skip-light.html"
    );
    ...
    jQuery(".ico-site-search img.top").attr(
      "src",
      "assets-new/assets/images/ico-site-search-y.png"
    );
    jQuery(".ico-site-search img.bottom").attr(
      "src",
      "assets-new/assets/images/ico-site-search-light.png"
    );

    jQuery(".ico-sitemap img.top").attr(
      "src",
      "assets-new/assets/images/ico-sitemap-y.png"
    );
    jQuery(".ico-sitemap img.bottom").attr(
      "src",
      "assets-new/assets/images/ico-sitemap-light.html"
    );

    jQuery(".ico-accessibility img.top").attr(
      "src",
      "assets-new/assets/images/ico-accessibility-light.png"
    );
    jQuery(".ico-accessibility img.bottom").attr(
      "src",
      "assets-new/assets/images/ico-accessibility-light.png"
    );
  });
  jQuery(".light").click(function () {
    ...
    jQuery(".ico-skip img.top").attr(
      "src",
      "assets-new/assets/images/ico-skip.png"
    );
    jQuery(".ico-skip img.bottom").attr(
      "src",
      "assets-new/assets/images/ico-skip-light.html"
    ...
    jQuery(".ico-site-search img.top").attr(
      "src",
      "assets-new/assets/images/ico-site-search.png"
    );
    jQuery(".ico-site-search img.bottom").attr(
      "src",
      "assets-new/assets/images/ico-site-search-light.png"
    ...
    jQuery(".ico-sitemap img.top").attr(
      "src",
      "assets-new/assets/images/ico-sitemap.png"
    );
    jQuery(".ico-sitemap img.bottom").attr(
      "src",
      "assets-new/assets/images/ico-sitemap-light.html"
    ...
    jQuery(".ico-accessibility img.top").attr(
      "src",
      "assets-new/assets/images/ico-accessibility.png"
    );
    jQuery(".ico-accessibility img.bottom").attr(
      "src",
      "assets-new/assets/images/ico-accessibility-light.png"
    ...
    jQuery(".sw-logo img").attr(
      "src",
      "assets-new/assets/images/swach-bharat.png"
    );
  });
