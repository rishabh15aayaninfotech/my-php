            ...
            <ul id="header-nav">
                  ...
                  <div class="google-find">
                    <form method="get" action="http://www.google.com/search" target="_blank">
                      ...
                      <div class="">
                        ...
                        <input type="radio" name="sitesearch" value="india.gov.in" checked id="the_domain" />
              ...
              <li class="ico-accessibility cf">
                ...
                <ul style="visibility: hidden;">
                  ...
                  <li> <a onClick="set_font_size()" title="Reset font size" href="javascript:void(0);"
                  ...
                  <li> <a href="javascript:void(0);" class="high-contrast dark" title="High Contrast" role="link">A</a>
                  </li>
                  <li> <a href="javascript:void(0);" class="high-contrast light" title="Normal Contrast"
                      style="display: none;" role="link">A</a> </li>
                </ul>
              </li>
              <li class="ico-social cf">
                ...
                <ul>
                  ...
                  <li>
                    <a target="_blank" title="External Link that opens in a new window"
                      href="https://www.youtube.com/channel/UCeLoQeBr4NUD_ivaqnASeKg/videos"><img alt="youtube Page"
                        src="assets-new/assets/images/ico-youtube.png"></a>
                  </li>
                </ul>
              </li>
              ...
              <li class="hindi cmf_lan m-hide">
                ...
                <ul>
                  <li>
                    <a href="index.php" lang="en" class="alink" title="Click here for English version.">English</a>
                  </li>
                  <li>
                    <a href="hindi-index.php" lang="hi" class="alink" title="Click here for हिन्दी version.">हिन्दी</a>
                  </li>
                </ul>
              </li>
  ...
  <section class="wrapper megamenu-wraper">
    <div class="container-fluid common-container four_content">
      ...
      <nav class="main-menu clearfix" id="main_menu">
        <ul class="nav-menu">
          <li class="nav-item"> <a href="hindi-index.php" class="home" role="link" aria-label="home"><span
                style="display: none;">Home</span><i class="fa fa-home"></i></a> </li>
          <li class="nav-item">
            <a href="#" role="link" aria-label="profile">प्रोफ़ाइल</a>
            <div class="sub-nav">
              <ul class="sub-nav-group">
                <li><a href="hindi-history.php" role="link" aria-label="history">इतिहास</a></li>
                ...
                <li class="menu-item">
                  ...
                  <div class="dropdown-menu">
                    <ul class="dropdown-list">
                      <li><a href="hindi-parental-background.php" class="dropdown-item" role="link"
                          aria-label="Biography">पैतृक
                          पृष्ठभूमि</a></li>
                      <li><a href="hindi-education-career.php" class="dropdown-item" role="link"
                          aria-label="Publications">शैक्षिक योग्यताएं</a></li>
                      <li><a href="hindi-general-interest.php" class="dropdown-item" role="link"
                          aria-label="Contributions">सामान्य रूचि</a></li>
                      <li><a href="hindi-incident-of-youth.php" class="dropdown-item" role="link"
                          aria-label="Awards">युवाओं का
                          वृत्तांत</a></li>
                      <li><a href="hindi-honours.php" class="dropdown-item" role="link" aria-label="Awards">सम्मान</a>
                      </li>
                      <li class="menu-item">
                        <a href="#" class="dropdown-item" role="link" aria-label="contri">योगदान</a>
                        <div class="dropdown-menu">
                          <ul class="dropdown-list">
                            <li><a href="hindi-living.php" class="dropdown-item" role="link"
                                aria-label="living">जीविका</a></li>
                            <li><a href="hindi-fossil.php" class="dropdown-item" role="link"
                                aria-label="fossil">जीवाश्म</a></li>
                            <li><a href="hindi-geology.php" class="dropdown-item" role="link"
                                aria-label="geology">भूगर्भ विज्ञान</a></li>
                          </ul>
                        </div>
                      </li>
                </li>
                <li><a href="hindi-honours.php" class="dropdown-item" role="link"
                    aria-label="Research-Projects">सम्मान</a></li>
              </ul>
            </div>
          </li>
          <li><a href="hindi-mrs-savitri-sahni.php" role="link" aria-label="home">श्रीमती
              सावित्री
              साहनी</a></li>
        </ul>
    </div>
    ...
    <li class="nav-item">
      ...
      <div class="sub-nav">
        <ul class="sub-nav-group">
          <li><a href="hindi-governing-body.php" role="link" aria-label="home">शासी मंडल</a></li>
          <li><a href="hindi-research-advisory-council.php" role="link" aria-label="home">अनुसंधान
              सलाहकार परिषद</a></li>
          <li><a href="hindi-finance-committee.php" role="link" aria-label="home">वित्त समिति</a></li>
          <li><a href="hindi-building-committee.php" role="link" aria-label="home">भवन समिति</a></li>
          <li><a href="hindi-director.php" role="link" aria-label="home">निदेशक</a></li>
          <li><a href="hindi-organizational-setup.php" role="link" aria-label="home">संगठनात्मक
              व्यवस्था</a></li>
          <li><a href="hindi-past-heads.php" role="link" aria-label="home">संस्थान के
              पुर्व-प्रमुख</a></li>
          <li><a href="hindi-past-president-chairman.php" role="link" aria-label="home">पूर्व
              सभापति/अध्यक्ष</a></li>
        </ul>
      </div>
    </li>
    <li class="nav-item">
      ...
      <div class="sub-nav">
        <ul class="sub-nav-group">
          <li><a href="hindi-director-staff.php" role="link" aria-label="Director Page">निदेशक</a></li>
          <li><a href="hindi-scientific.php" role="link" aria-label="Scientific Staff Page">वैज्ञानिक</a></li>
          <li><a href="hindi-technical.php" role="link" aria-label="Technical Staff Page">तकनीकी</a></li>
          <li><a href="hindi-administrative.php" role="link" aria-label="Administrative Staff Page">प्रशासनिक</a></li>
          <li><a href="hindi-superannuated.php" role="link" aria-label="Superannuated Staff Page">वयोवृद्ध</a></li>
        </ul>
    ...
    <li class="nav-item"><a href="hindi-rajbhasha-patal.php" role="link" aria-label="home">राजभाषा पटल</a>
    </li>
